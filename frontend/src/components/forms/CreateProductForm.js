...
const CreateProductForm = ({
    ...
    const { title, description, price, category, subcategory, quantity, sold, images, shipping, color, brand } = values;
    const { Option } = Select;
    ...
    return (
        ...
        >
            ...
            >
                <Input name="title" placeholder="Enter product title" onChange={handleChange} value={title} />
            </Form.Item>
            ...
            >
                <Input name="price" placeholder="Enter product price" onChange={handleChange} value={price} />
            </Form.Item>
            ...
            <Form.Item label="Sold" name="sold">
                <Input name="sold" placeholder="Enter product sold number" onChange={handleChange} value={sold} />
            </Form.Item>
        ...
        />
            ...
            <Form.Item label="Color" name="color" rules={[{ required: true, message: "Please add product color" }]}>
                <Select
                    name="color"
